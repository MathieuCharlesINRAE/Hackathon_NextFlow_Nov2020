...
#line 162 "pwmsearch.c"

XS_EUPXS(XS_TFBS__Ext__pwmsearch_search_xs); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_TFBS__Ext__pwmsearch_search_xs)
{
    dVAR; dXSARGS;
    if (items != 6)
...
extern "C"
#endif
XS_EXTERNAL(boot_TFBS__Ext__pwmsearch); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_TFBS__Ext__pwmsearch)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
...
#  endif
        ...
        newXS_deffile("TFBS::Ext::pwmsearch::search_xs", XS_TFBS__Ext__pwmsearch_search_xs);
#if PERL_VERSION_LE(5, 21, 5)
